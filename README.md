...
- 🦄【[orcache](https://github.com/orca-zhang/orcache) 】本地内存缓存，Extremely easy, fast, concurrency-safe and support distributed consistency. 
  - 🤏 代码量<300行、30s完成接入   🚀 高性能、极简设计、并发安全
  - 🏳️‍🌈 支持`LRU` 和 `LRU-2`两种模式   🦖 额外小组件支持分布式一致性
